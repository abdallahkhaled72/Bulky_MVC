...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult UpdateOrderDetail()
        {
            ...
            orderHeaderFromDb.PostalCode = OrderVM.OrderHeader.Name;
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                // "all" case or empty status - no filtering needed
                Console.WriteLine("Showing all orders (no filtering applied)");
            }
            //switch (status)
            //{
            //    case "pending":
            ...
            //        break;
            //    default:
            //        Console.WriteLine($"Default case reached with status: '{status}'");
            //        break;
            //}
